 ...
 *
 * Two eyebrow strings per bucket, per docs/OUR-FRAME-DESIGN-SYSTEM.md:
 * `overviewEyebrow` is the short form board 2 shows on the Photos overview
 * cards (§8), `eyebrow` is the longer editorial form the category pages use
 * (§9). Three of the four are identical in both places; only Arjun differs.
 */
export const BUCKETS = [
  {
    id: '1JMutj12MQTZcbkhzBE1W8pH0TCt2GxVf',
    eyebrow: 'Growing Up, Frame by Frame',
    overviewEyebrow: 'Growing Up',
  ...
  },
  {
    ...
    overviewEyebrow: 'Stories From Everywhere',
  ...
  },
  {
    ...
    overviewEyebrow: 'Anchor Memories',
  ...
  },
  {
    ...
    overviewEyebrow: 'People & Moments',
